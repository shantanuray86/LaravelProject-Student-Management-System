    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ url('/admin/teacher/save') }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select class="form-control{{ $errors->has('classes_id') ? ' is-invalid' : '' }}" name="classes_id[]" multiple required>
                ...
                <!-- This is for Adding Subjects against a particular teacher. -->
                <div class="form-group row" id="template">
                    
                    <label for="classes_id" class="col-md-4 col-form-label text-md-right">Subject</label>

                    <div class="col-md-6 template">
                        <div class="removeThisDropDown"> 
                        <button type="button" class="btn btn-danger deletedropdown" id="deletedropdown" style="visibility: hidden;">Delete Subject</button> 
                                         
                        <select class="form-control{{ $errors->has('classes_id') ? ' is-invalid' : '' }}" name="subject_id[]" required>
                ...
                <div class="form-group row col-md-6 offset-md-3">
                    <button type="button" class="btn btn-primary" id="clone">Add More Subjects</button>
                </div>
                <div class="form-group row col-md-6 offset-md-4">                    
                    <div class="col-md-6" id="newtemplate" class="newtemplate">
                    </div>
                </div>
                <!--###############################################################-->
                <div class="form-group row">
...
jQuery(document).ready(function() {
    $(function(){
        $('#clone').on("click",function() {
            ...
            // Get the select box html in the DIV
            var drpval = $('.template').html();
            // Append this html(clone it) in the next DIV with ID newtemplate
            $('#newtemplate').append(drpval);
            // Make the delete button visible by removing it's style arrtibute
            $('#newtemplate .deletedropdown').removeAttr("style"); 
            
        });
        // $('#newtemplate .deletedropdown').on("click",function(e) {
        //     //$(this).last().remove();
        //     alert('hello');
        //     //$(this).parent('.removeThisDropDown').remove();
        // });
        $(document).on('click', '#newtemplate .deletedropdown', function () {
            // your function here
            $(this).parent('.removeThisDropDown').remove();
        });
    });
