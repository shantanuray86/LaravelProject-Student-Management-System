...
Route::any('/admin/student/studentSubjectRelation/{id}','StudentController@studentSubjectRelation')->name('studentSubjectRelation');
...
Route::get('/admin/subject/edit/{id}', 'SubjectController@edit')->name('subjectedit');
Route::post('/admin/subject/update/{id}', 'SubjectController@update')->name('subjectupdate');
...
Route::get('student/myclass/{id}', 'Users\StudentController@myclass')->name('myclass');
Route::get('student/myinfo/{id}', 'Users\StudentController@myinfo')->name('myinfo');
